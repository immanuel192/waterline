...
module.exports = {
  ...
  define: function(cb) {
    ...
    this.describe(function(err, existingAttributes) {
      ...
      // Inject our self collection models to make sure some RDBMS such as Postgresql can understand schemaName
      adapter.define(connName, self.collection, schema, cb, self);
    });
  },
